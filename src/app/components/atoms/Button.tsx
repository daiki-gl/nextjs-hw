    ...
    return (
        <button
            ...
            className={`cursor-pointer  
                ...
                ${noDeco ? 'text-blue-500 hover:text-gray-300 underline inline-block mr-22 text-left hover:!bg-transparent' : ''}
                ${outline == false && noDeco == false ? 'bg-blue-500 rounded-md px-4 py-2 mr-6 mt-4 text-white' : ''}
                ${disabled ? 'opacity-50 !cursor-not-allowed bg-gray-500' : ' hover:bg-blue-600 '} 
                `}
        >
            {text}
        </button>
